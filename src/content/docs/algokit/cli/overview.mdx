...
- [Bootstrap](/algokit/cli/features/project_cmd/bootstrap/) - Bootstrap AlgoKit project dependencies
...
- [Task](/algokit/cli/features/task/) - Perform a variety of useful operations on the Algorand blockchain
