...
If you are building a smart contract using the production [AlgoKit init templates](https://github.com/algorandfoundation/algokit-cli/blob/main/docs/features/init) provide a reference implementation out of the box for the deploy-time immutability and permanence control.
