...
The key function to facilitate Algo transfers is `algokit.transferAlgos(transfer, algod)`, which returns a [`SendTransactionResult`](/build/algokit/utils/ts/transaction#send-transaction-result) and takes a [`AlgoTransferParams`](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/docs/code/interfaces/types_transfer.AlgoTransferParams.md):

- All properties in [`SendTransactionParams`](/build/algokit/utils/ts/transaction#send-transaction-params)
...
The key function to facilitate asset transfers is `transferAsset(transfer, algod)`, which returns a [`SendTransactionResult`](/build/algokit/utils/ts/transaction#send-transaction-result) and takes a [`TransferAssetParams`](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/docs/code/interfaces/types_transfer.TransferAssetParams.md):
