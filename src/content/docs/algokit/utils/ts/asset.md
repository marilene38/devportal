...
The [`AssetManager`](../code/classes/types_asset_manager.AssetManager) is a class that is used to manage asset information.
...
The base type for specifying an asset creation transaction is [`AssetCreateParams`](../code/modules/types_composer#assetcreateparams), which has the following parameters in addition to the [common transaction parameters](./algorand-client#transaction-parameters):
...
The base type for specifying an asset creation transaction is [`AssetConfigParams`](../code/modules/types_composer#assetconfigparams), which has the following parameters in addition to the [common transaction parameters](./algorand-client#transaction-parameters):
...
The base type for specifying an asset transfer transaction is [`AssetTransferParams`](../code/modules/types_composer#assettransferparams), which has the following parameters in addition to the [common transaction parameters](./algorand-client#transaction-parameters):
...
The base type for specifying an asset opt-in transaction is [`AssetOptInParams`](../code/modules/types_composer#assetoptinparams), which has the following parameters in addition to the [common transaction parameters](./algorand-client#transaction-parameters):
...
The base type for specifying an asset opt-out transaction is [`AssetOptOutParams`](../code/modules/types_composer#assetoptoutparams), which has the following parameters in addition to the [common transaction parameters](./algorand-client#transaction-parameters):
...
The [`asset.bulkOptIn`](../code/classes/types_asset_manager.AssetManager#bulkoptin) function facilitates the opt-in process for an account to multiple assets, allowing the account to receive and hold those assets.
...
The [`asset.bulkOptOut`](../code/classes/types_asset_manager.AssetManager#bulkoptout) function facilitates the opt-out process for an account from multiple assets, permitting the account to discontinue holding a group of assets.
