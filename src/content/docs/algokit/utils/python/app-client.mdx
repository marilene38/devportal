...
:::note
If you are using the [AlgoKit CLI](/getting-started/first-contract-guide) to bootstrap and manage your project, the included build scripts will generate your app client for you. The generated client will be placed in the `smart_contracts/artifacts/{app_name}` directory.
:::
