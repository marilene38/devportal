---
title: Interface: TemplateStringsArray
---
...
[@algorandfoundation/algorand-typescript](../../../README) / [index](../../README) / [\<internal\>](../README) / TemplateStringsArray
...
> **\[iterator\]**(): [`ArrayIterator`](ArrayIterator)\<`string`\>
...
[`ArrayIterator`](ArrayIterator)\<`string`\>
...
...(`string` \| [`ConcatArray`](ConcatArray)\<`string`\>)[]
...
> **entries**(): [`ArrayIterator`](ArrayIterator)\<\[`number`, `string`\]\>
...
[`ArrayIterator`](ArrayIterator)\<\[`number`, `string`\]\>
...
> **flat**\<`A`, `D`\>(`this`, `depth`?): [`FlatArray`](../type-aliases/FlatArray)\<`A`, `D`\>[]
...
[`FlatArray`](../type-aliases/FlatArray)\<`A`, `D`\>[]
...
> **values**(): [`ArrayIterator`](ArrayIterator)\<`string`\>
