...
2. Using an instance of `GlobalState`, which gives [some extra features](./api-algopy#algopy.GlobalState) to understand
...
This is represented in Algorand Python by using an instance of [`LocalState`](./api-algopy#algopy.LocalState).
...
We provide 3 different types for accessing box storage: [Box](./api-algopy#algopy.Box), [BoxMap](./api-algopy#algopy.BoxMap), and [BoxRef](./api-algopy#algopy.BoxBlob). We also expose raw operations via the [AVM ops](./lg-ops) module.
