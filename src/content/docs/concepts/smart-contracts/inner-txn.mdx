...
<Tabs syncKey='lang'>
  <TabItem label='Python' icon='seti:python'>
    <RemoteCode
      src='https://raw.githubusercontent.com/algorandfoundation/devportal-code-examples/refs/heads/main/projects/python-contract-examples/smart_contracts/inner_transactions/contract.py'
      snippet='PAYMENT'
      lang='py'
