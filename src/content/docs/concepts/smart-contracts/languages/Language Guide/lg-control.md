...
If statements work the same as Python. The conditions must be an expression that evaluates to bool, which can include a [String or Uint64](../../language-guide/lg-types) among others.
...
Ternary conditions work the same as Python. The condition must be an expression that evaluates to bool, which can include a [String or Uint64](../../language-guide/lg-types) among others.
...
While loops work the same as Python. The condition must be an expression that evaluates to bool, which can include a [String or Uint64](../../language-guide/lg-types) among others.
...
For loops are used to iterate over sequences, ranges and [ARC-4 arrays](../../language-guide/lg-arc4). They work the same as Python.
