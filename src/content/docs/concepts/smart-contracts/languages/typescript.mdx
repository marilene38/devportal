...
:::note
To install and start writing Algorand Typescript smart contracts refer to this [page](algokit/concepts/smart-contracts/languages/typescript)
:::

## Typescript Implementation for AVM

Algorand Typescript maintains the syntax and semantics of Typescript, supporting a subset of the language that will grow over time. However, due to the restricted nature of the AVM, it will never be a complete implementation. To learn more refer to AVM Docs(concepts/smart-contracts/avm).
...
To debug and test your smart contracts, refer to [Algokit Typescript Test ](/algokit/unit-testing/typescript/overview) and [Algokit Typescript Debugging] (/algokit/utils/ts/debugging)
