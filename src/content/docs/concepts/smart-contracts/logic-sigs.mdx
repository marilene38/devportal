...
<Tabs syncKey='lang'>
  <TabItem label='Python' icon='seti:python'>
    <RemoteCode
      src='https://raw.githubusercontent.com/algorandfoundation/devportal-code-examples/refs/heads/main/projects/python-contract-examples/smart_contracts/self_payment/contract.py'
...
<Tabs syncKey='lang'>
  <TabItem label='Python' icon='seti:python'>
    <RemoteCode
      src='https://raw.githubusercontent.com/algorandfoundation/devportal-code-examples/refs/heads/main/projects/python-contract-examples/smart_contracts/subsidize_app_call/contract.py'
