...
import createLocalStatePython from '/examples/smart-contracts/py/storage-local-init-py.py?raw';
import getLocalStoragePython from '/examples/smart-contracts/py/storage-local-init-py.py?raw';
import setLocalStoragePython from '/examples/smart-contracts/py/storage-local-init-py.py?raw';
import deleteLocalStoragePython from '/examples/smart-contracts/py/storage-local-init-py.py?raw';
import {
  getLocalStorageTEAL,
  setLocalStorageTEAL,
