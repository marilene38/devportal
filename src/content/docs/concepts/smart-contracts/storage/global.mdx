...
import createGlobalStatePython from '/examples/smart-contracts/py/storage-global-init-py.py?raw';
import getGlobalStoragePython from '/examples/smart-contracts/py/storage-global-get-py.py?raw';
import deleteGlobalStoragePython from '/examples/smart-contracts/py/storage-global-delete-py.py?raw';
import setGlobalStoragePython from '/examples/smart-contracts/py/storage-global-set-py.py?raw';
import {
...
Refer [Sinppet
Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L178-L226)
...
Refer [Sinppet
Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L249-L252)
...
Refer [Sinppet
Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L253-L258)
