...
<figure>
  ...
  <figcaption>Figure: Rekey Standard Account</figcaption>
</figure>

### Standard Account

Use the following code sample to view a standard account on localnet:
...
Next, modify your command to display results for this rekeyed account `L42DW7MSHP4PMIAZSDAXYTZVHTE756KGXCJYGFKCET5XHIAWLBYYNSMZQU`:

```shell showLineNumbers=false frame=none
goal account dump --address L42DW7MSHP4PMIAZSDAXYTZVHTE756KGXCJYGFKCET5XHIAWLBYYNSMZQU
```
...
rekey.txn[0]
{
  "txn": {
    ...
    "fv": 13,
    "gen": "dockernet-v1",
    "gh": "vcylk8SA+P4FtSqsjC6lPg9SSQ4N4vceuS0YtfwINNs=",
    "lv": 1013,
    "note": "nhQgvEgErb0=",
    "rcv": "AOHTIQTUP5GFSZA2G4HIARTZRGM6P4X2HGPJVHTCRN7VJKR4IWCFZKC25A",
    "rekey": "ICMJAXIDMRQ3W5T2T3O352NDA2KJQWPFS3G4SR74DJLOL7N46YET2CWHUA",
    "snd": "AOHTIQTUP5GFSZA2G4HIARTZRGM6P4X2HGPJVHTCRN7VJKR4IWCFZKC25A",
    "type": "pay"
  }
}
```
...
Adding the currently authorized signature(s) to a rekey-to transaction is required before sending it to the network for confirmation. The “snd" field provides the address to the account object where the "auth-addr” field is defined. The examples provided below demonstrate the commands in detail and allow you to rekey accounts in various scenarios.
...
<figure>
  ...
  <figcaption>Figure: Rekeying to a Single Address</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Figure: Rekeying to a Multisig Address</figcaption>
</figure>
