...
<iframe
  ...
  src='https://www.youtube-nocookie.com/embed/94XMLuTt8nM'
...
- Before a new asset can be transferred to a specific account the receiver must opt-in to receive the asset. This process is described in [Receiving an asset](FUTURELINK).
  {/* TODO #receiving-an-asset */}
...
- [AssetName]() (_optional, but recommended_)
  ../transactions/transactions#assetname
- [UnitName]() (_optional, but recommended_)
  ../transactions/transactions#unitname
- [Total]() (_required_)
  ../transactions/transactions#total
- [Decimals]() (_required_)
  ../transactions/transactions#decimals
...
The manager account is the only account that can authorize transactions to [re-configure](FUTURELINK) or [destroy](FUTURELINK) an asset.
{/* TODO #modifying-an-asset */}
{/* TODO #destroying-an-asset */}
...
<iframe
  width='100%'
  style='aspect-ratio:16/9'
  src='https://www.youtube-nocookie.com/embed/_Q37eysrRh4'
  title='YouTube video player'
  frameborder='0'
  allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share'
  allowfullscreen
