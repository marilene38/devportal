...
The type of asset that is created will depend on the parameters that are passed during asset creation and sometimes during asset re-configuration. View the full list of asset parameters in the [Asset Parameters Reference](/concepts/transactions/transactions#asset-parameters).
...
| [AssetName](/concepts/transactions/transactions#assetname)               | _No, but recommended_ |             |
| [UnitName](/concepts/transactions/transactions#unitname)                 | _No, but recommended_ |             |
| [Total](/concepts/transactions/transactions#total)                       | _YES_                 |             |
| [Decimals](/concepts/transactions/transactions#decimals)                 | _YES_                 |             |
| [DefaultFrozen](/concepts/transactions/transactions#defaultfrozen) _YES_ |                       |
| [URL](/concepts/transactions/transactions#url)                           | _No_                  |             |
| [MetaDataHash](/concepts/transactions/transactions#metadatahash)         | (_No_)                |             |
...
[**Manager Address**](/concepts/transactions/transactions#manageraddr)
...
[**Reserve Address**](/concepts/transactions/transactions#reserveaddr)
...
[**Freeze Address**](/concepts/transactions/transactions#freezeaddr)
...
[**Clawback Address**](/concepts/transactions/transactions#clawbackaddr)
...
If any of these four addresses is set to the empty string `""` that address will be cleared and can never be reset for the life of the asset. This will also effectively disable the feature of that address. For example setting the freeze address to the empty string `""` will prevent the asset from ever being frozen.
