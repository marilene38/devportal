...
- [Silvio explains how Algorand consensus works at a meetup](https://www.youtube.com/watch?v=NykZ-ZSKkxM) in Milan (video, simple, longer but worth it).
- Silvio describes [Algorand’s core technology in a nutshell](https://medium.com/algorand/algorands-core-technology-in-a-nutshell-e2b824e03c77)(blog post, simple, worth it).
- A [simple, introductory video](https://www.youtube.com/watch?v=gACVKaNqxPs) on Algorand’s consensus protocol (video, simple, short)
- [Docs on Algorand consensus](../../get-details/algorand_consensus.md) (technical, medium-length, somewhere in between the simple video above and the full whitepaper)
- [The official Algorand whitepaper](https://algorandcom.cdn.prismic.io/algorandcom%2Fece77f38-75b3-44de-bc7f-805f0e53a8d9_theoretical.pdf) (very technical, detailed)
...
<Image src={imgPos} alt='Initializing an Account' />
...
<Image src={imgPow} alt='Initializing an Account' />
...
> Visit the [Algorand Foundation website](https://algorand.co/staking-rewards) for more information.
