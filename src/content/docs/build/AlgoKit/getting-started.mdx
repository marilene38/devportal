...
AlgoKit is a simple, comprehensive toolkit for developers to quickly and easily build and launch secure, automated,
...
for writing smart contracts! This empowers developers to write Algorand smart contracts in regular Python, one of the world's
...
initialized project and you will be prompted to install appropriate VS Code extensions.
