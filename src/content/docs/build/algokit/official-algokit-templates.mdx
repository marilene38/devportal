...
AlgoKit provides several official templates to cater to different development needs. These templates will create a [standalone AlgoKit project](/build/algokit/project-structure#standalone-projects).
...
<Steps>
1. [Install AlgoKit](/build/algokit/getting-started) and all the prerequisites mentioned in the installation guide.
