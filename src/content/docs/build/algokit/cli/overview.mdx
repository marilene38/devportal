...
- [project](/build/algokit/cli/features/project/) - Manage an AlgoKit project workspace on your file system
- [Tasks](/build/algokit/cli/features/tasks/) - Perform a variety of useful operations on the Algorand blockchain
...
- `--skip-version-check` Skips updated AlgoKit version checking and prompting for that execution, this can also be disabled permanently on a given machine with `algokit config version-prompt disable`.
