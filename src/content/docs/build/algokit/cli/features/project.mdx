...
`algokit project` is a collection of commands and command groups useful for managing algokit compliant [project workspaces](/build/algokit/cli/features/init#workspaces-vs-standalone-projects).
...
```d2
"'algokit project' command group" -> "Standalone Project (.algokit.toml)"
"'algokit project' command group" -> "Workspace (.algokit.toml)"
"Workspace (.algokit.toml)" -> "Sub-Project 1 (.algokit.toml)"
"Workspace (.algokit.toml)" -> "Sub-Project 2 (.algokit.toml)"
"Standalone Project (.algokit.toml)" -> "Custom Commands defined in .algokit.toml"
"Sub-Project 1 (.algokit.toml)" -> "Custom Commands defined in .algokit.toml"
"Sub-Project 2 (.algokit.toml)" -> "Custom Commands defined in .algokit.toml"
```
