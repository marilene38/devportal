...
Git is a prerequisite for the init command as it is used to clone templates and initialize git repos. Please consult the [AlgoKit Getting Started Guide](/tutorials/getting-started#prerequisites) for installation instructions.
