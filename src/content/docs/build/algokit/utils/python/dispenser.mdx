...
import dispenserClientExample from '/src/examples/algokit/py/algokit-utils-py-dispenser-client.py?raw';
...
<Aside>
  ...
  endpoint and pass the `txn_id` of your refund transaction. You can obtain the
  dispenser address by inspecting the `sender` field of any issued `fund`
