...
import createExample from '/src/examples/algokit/algokit-utils-py-app-client-create.py?raw';
import callAppMethodsExample from '/src/examples/algokit/algokit-utils-py-app-client-call-app-methods.py?raw';
import abiMethodsExample from '/src/examples/algokit/algokit-utils-py-app-client-abi-methods.py?raw';
import composingExample from '/src/examples/algokit/algokit-utils-py-app-client-composing.py?raw';
