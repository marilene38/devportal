...
import example from '/src/examples/algokit/algokit-utils-py-client.py?raw';
import clientsExample from '/src/examples/algokit/algokit-utils-py-client-clients.py?raw';
import networkExample from '/src/examples/algokit/algokit-utils-py-client-network.py?raw';
