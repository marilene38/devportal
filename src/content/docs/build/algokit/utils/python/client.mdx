...
import example from "/src/content/examples/algokit/algokit-utils-py-client.py?raw"; 
import clientsExample from "/src/content/examples/algokit/algokit-utils-py-client-clients.py?raw"; 
import networkExample from "/src/content/examples/algokit/algokit-utils-py-client-network.py?raw"; 
export const highlights = ['algosdk.v2client.algod.AlgodClient', 'algosdk.v2client.indexer.IndexerClient', 'algosdk.kmd.KMDClient'];
