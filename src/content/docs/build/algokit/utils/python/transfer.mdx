...
import transferAlgosExample from '/src/examples/algokit/algokit-utils-py-transfer-transfer-algos.py?raw';
import transferAssetsExample from '/src/examples/algokit/algokit-utils-py-transfer-transfer-assets.py?raw';
import ensureMinAlgosExample from '/src/examples/algokit/algokit-utils-py-transfer-ensure-min.py?raw';
import dispenserAccountExample from '/src/examples/algokit/algokit-utils-py-transfer-dispenser-account.py?raw';
