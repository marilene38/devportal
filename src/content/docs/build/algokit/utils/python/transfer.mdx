...
import transferAlgosExample from '/src/examples/algokit/py/algokit-utils-py-transfer-transfer-algos.py?raw';
import transferAssetsExample from '/src/examples/algokit/py/algokit-utils-py-transfer-transfer-assets.py?raw';
import ensureMinAlgosExample from '/src/examples/algokit/py/algokit-utils-py-transfer-ensure-min.py?raw';
import dispenserAccountExample from '/src/examples/algokit/py/algokit-utils-py-transfer-dispenser-account.py?raw';
...
<Aside>
  ...
  `ALGOKIT_DISPENSER_ACCESS_TOKEN` environment variable prior to invoking
  `ensure_funded`. To generate the token refer to [AlgoKit CLI
