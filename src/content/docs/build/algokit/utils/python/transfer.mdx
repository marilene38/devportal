...
There is a standard AlgoKit Utils function to get access to a [dispenser account](/build/algokit/utils/python/account):
...
Please note that this does not refer to the [AlgoKit TestNet Dispenser API](/build/algokit/utils/python/dispenser) which is a
