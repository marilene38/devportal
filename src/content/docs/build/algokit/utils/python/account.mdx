...
import accountFromPKExample from "/src/content/examples/algokit/algokit-utils-py-account-pk.py?raw";
import accountFromPKAddrExample from "/src/content/examples/algokit/algokit-utils-py-account-pk-addr.py?raw";
import getAccountExample from "/src/content/examples/algokit/algokit-utils-py-account-get_account.py?raw";
import newAccountExample from "/src/content/examples/algokit/algokit-utils-py-account-new_account.py?raw";
import example from "/src/content/examples/algokit/algokit-utils-py-account-example.py?raw";
export const highlights = ['Account(private_key)', 'Account(private_key, address=account_address)', 'get_account()', 'new_account()'];
...
- **`Account(private_key, address)`**: Load an existing account from a private key and address, useful for re-keyed accounts
    ...
    <Code code={accountFromPKAddrExample} lang="py" frame="none" mark={highlights} />
