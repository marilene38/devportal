...
import accountFromPKExample from '/src/examples/algokit/py/algokit-utils-py-account-pk.py?raw';
import accountFromPKAddrExample from '/src/examples/algokit/py/algokit-utils-py-account-pk-addr.py?raw';
import getAccountExample from '/src/examples/algokit/py/algokit-utils-py-account-get_account.py?raw';
import newAccountExample from '/src/examples/algokit/py/algokit-utils-py-account-new_account.py?raw';
import example from '/src/examples/algokit/py/algokit-utils-py-account-example.py?raw';
