...
title: Testing
prev:
  link: /build/algokit/utils/ts/debugging/
next:
...
The key when generating a test account is getting hold of a [dispenser](/build/algokit/utils/ts/transfer#dispenser) and then [ensuring the test account is funded](/build/algokit/utils/ts/transfer#ensuring-minimum-algos).
