...
next:
    link: /build/algokit/utils/ts/reference/
sidebar:
  order: 10
---
...
import testingJest from '/examples/algokit/utils-ts/algokit-utils-ts-testing-jest.ts?raw';
import testingVitest from '/examples/algokit/utils-ts/algokit-utils-ts-testing-vitest.ts?raw';
import testingJestLog from '/examples/algokit/utils-ts/algokit-utils-ts-testing-jest-log.ts?raw';
import testingVitestLog from '/examples/algokit/utils-ts/algokit-utils-ts-testing-vitest-log.ts?raw';
import testingSnapshot from '/examples/algokit/utils-ts/algokit-utils-ts-testing-snapshot.ts?raw';
...
- `testAccountFunding?: AlgoAmount` - The [amount](/build/algokit/utils/ts/amount) of funds to allocate to the default testing account, if not specified then it will get `10` ALGOs
