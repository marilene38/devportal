...
This will turn on things like automatic tracing, more verbose logging and [advanced debugging](/build/algokit/utils/ts/debugging). It's likely this option will result in extra HTTP calls to algod so worth being careful when it's turned on.
