...
import appDeploymentLifecycle from '../../../../../../assets/lifecycle.jpg';
...
1. **Development**
   ...
   3. **_Verify_** the TEAL Templates maintain [output stability](https://github.com/algorandfoundation/algokit-cli/blob/main/docs/articles/output_stability.md) and any other static code quality checks
2. **Deployment**
...
<Image src={appDeploymentLifecycle} alt='App deployment lifecycle' />
