...
import instantiate_appclient from '/src/examples/algokit/algokit-utils-py-clients-overview-instantiate-appclient.py?raw';
import deploy_contract from '/src/examples/algokit/algokit-utils-py-clients-overview-deploy-contract.py?raw';
import call_method from '/src/examples/algokit/algokit-utils-py-clients-overview-call-method.py?raw';
...
To learn about all properties, accessors, and methods available in the AlgorandClient, refer to the [AlgorandClient reference page]( https://github.com/algorandfoundation/algokit-utils-ts/blob/main/docs/code/classes/types_algorand_client.AlgorandClient.md)
