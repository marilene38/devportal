...
- [Bootstrap](/build/algokit/cli/features/project_cmd/bootstrap/) - Bootstrap AlgoKit project dependencies
- [Compile](/build/algokit/cli/features/compile/) - Compile Algorand Python code
- [Completions](/build/algokit/cli/features/completions/) - Install shell completions for AlgoKit
- [Deploy](/build/algokit/cli/features/project_cmd/deploy/) - Deploy your smart contracts effortlessly to various networks
- [Dispenser](/build/algokit/cli/features/dispenser/) - Fund your TestNet account with ALGOs from the AlgoKit TestNet Dispenser
- [Doctor](/build/algokit/cli/features/doctor/) - Check AlgoKit installation and dependencies
- [Explore](/build/algokit/cli/features/explore/) - Explore Algorand Blockchains using lora
- [Generate](/build/algokit/cli/features/generate/) - Generate code for an Algorand project
- [Goal](/build/algokit/cli/features/goal/) - Run the Algorand goal CLI against the AlgoKit Sandbox
- [Init](/build/algokit/cli/features/init/) - Quickly initialize new projects using official Algorand Templates or community provided templates
- [LocalNet](/build/algokit/cli/features/localnet/) - Manage a locally sandboxed private Algorand network
- [project](/build/algokit/cli/features/project/) - Perform a variety of AlgoKit project workspace related operations like bootstrapping development environment, deploying smart contracts, running custom commands, and more
- [Tasks](/build/algokit/cli/features/tasks/) - Perform a variety of useful operations like signing & sending transactions, minting ASAs, creating vanity address, and more, on the Algorand blockchain
...
- [Algorand Python Documentation](/build/smart_contracts/python/overview/)
...
- [Algorand TypeScript Documentation](/build/smart_contracts/typescript/overview/)
- [Algorand TypeScript Github repo](https://github.com/algorandfoundation/puya-ts)
...
- [AlgoKit Utils TypeScript section](/build/algokit/utils/ts/overview/)
...
- [AlgoKit Utils Python section](/build/algokit/utils/python/overview/)
...
- [AlgoKit Localnet section](/build/cli/features/localnet/)
