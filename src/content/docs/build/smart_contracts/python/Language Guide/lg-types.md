...
`mulw`, etc - all of which are exposed through the [`algopy.op`](../../api-reference/api-algopy.op#module-algopy.op) module.
...
For more information look at the API reference for [`TemplateVar`](../../api-reference/api-algopy#algopy.TemplateVar).
...
Please see the [reference documentation](../../api-reference/api-algopy.arc4) for the different classes that can
be used to represent ARC-4 values or the [ARC-4 documentation](../../language-guide/lg-arc4) for more information
about ARC-4.
