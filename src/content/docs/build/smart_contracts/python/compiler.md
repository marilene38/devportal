...
|---------------------------------------|-------------------------------------------|----------------------------|
| [UInt64](../../api-reference/api-algopy#algopy.UInt64) | `algopy.TemplateVar[UInt64]("SOME_INT")`  | `SOME_INT=1234`            |
| [Bytes](../../api-reference/api-algopy#algopy.Bytes)   | `algopy.TemplateVar[Bytes]("SOME_BYTES")` | `SOME_BYTES=0x1A2B`        |
| [String](../../api-reference/api-algopy#algopy.String) | `algopy.TemplateVar[String]("SOME_STR")`  | `SOME_STR="hello"`         |
