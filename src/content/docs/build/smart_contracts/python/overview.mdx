---
title: Overview
description: Overview of the Algorand Python language.
---
...
:::note
To install and start writing Algorand Python smart contracts refer to this [page](/build/algokit/getting-started)
:::
...
For more details, refer to [Algokit installation page](/build/algokit/getting-started)
...
For more details, refer to [Algokit Python Test](/build/algokit/utils/py/testing) and [Algokit Python Debugging](/build/algokit/utils/python/debugging)
...
- Be aware of AVM limitations: When writing your smart contracts, consider the [restrictions](../constraints) imposed by the AVM.
...
For a comprehensive introduction to writing, compiling, and debugging a smart contract with Algorand Python, refer to the [Algokit Python smart contracts tutorial](/build/algokit/getting-started) for beginners. This tutorial provides step-by-step guidance on getting started with Algorand Python.
