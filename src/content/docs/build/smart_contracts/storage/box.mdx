...
Boxes are keyed storage segments associated with the apps itself. An app can create multiple boxes on-demand, each capable of storing up to 32kb of data. Both the box key and data are stored as byte arrays.
