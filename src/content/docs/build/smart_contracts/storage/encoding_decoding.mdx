...
[//]: # (Todo: These code snippets need to be imported from: https://github.com/algorand/js-algorand-sdk/blob/examples/examples/codec.ts#L16-L20)
<Tabs syncKey="lang">
...
[//]: # (Todo: These code snippets need to be imported from: https://github.com/algorand/java-algorand-sdk/blob/examples/examples/src/main/java/com/algorand/examples/CodecExamples.java#L35-L39)
<Tabs syncKey="lang">
	<TabItem label="Python" icon="seti:python">
		```python
...
[//]: # (Todo: These code snippets need to be imported from: https://github.com/algorand/java-algorand-sdk/blob/examples/examples/src/main/java/com/algorand/examples/CodecExamples.java#L42-L46)
<Tabs syncKey="lang">
	<TabItem label="Python" icon="seti:python">
		```python
        val = 1337
...
[//]: # (Todo: These code snippets need to be imported from: https://github.com/algorand/java-algorand-sdk/blob/examples/examples/src/main/java/com/algorand/examples/CodecExamples.java#L49-L58)
<Tabs syncKey="lang">
	<TabItem label="Python" icon="seti:python">
		```python
...
[//]: # (Todo: This code snippets need to be imported from: https://github.com/algorand/js-algorand-sdk/blob/examples/examples/codec.ts#L54-L60)
```javascript
...
[//]: # (Todo: These code snippets need to be imported from: https://github.com/algorand/java-algorand-sdk/blob/examples/examples/src/main/java/com/algorand/examples/CodecExamples.java#L70-L86)
<Tabs syncKey="lang">
	<TabItem label="Python" icon="seti:python">
		```python
