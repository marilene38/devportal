...
import createLocalStatePython from '/examples/storage-local-init-py.py?raw';
import getLocalStoragePython from '/examples/storage-local-init-py.py?raw';
import setLocalStoragePython from '/examples/storage-local-init-py.py?raw';
import deleteLocalStoragePython from '/examples/storage-local-init-py.py?raw';
import {
  getLocalStorageTEAL,
  setLocalStorageTEAL,
