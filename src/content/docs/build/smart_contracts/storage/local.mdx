...
import createLocalStatePython from '/src/examples/storage-local-init-py.py?raw';
import getLocalStoragePython from '/src/examples/storage-local-init-py.py?raw';
import setLocalStoragePython from '/src/examples/storage-local-init-py.py?raw';
import deleteLocalStoragePython from '/src/examples/storage-local-init-py.py?raw';
import {
  getLocalStorageTEAL,
  setLocalStorageTEAL,
