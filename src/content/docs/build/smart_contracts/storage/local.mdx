...
import createLocalStatePython from '/examples/smart_contracts/py/storage-local-init-py.py?raw';
import getLocalStoragePython from '/examples/smart_contracts/py/storage-local-init-py.py?raw';
import setLocalStoragePython from '/examples/smart_contracts/py/storage-local-init-py.py?raw';
import deleteLocalStoragePython from '/examples/smart_contracts/py/storage-local-init-py.py?raw';
import {
  getLocalStorageTEAL,
  setLocalStorageTEAL,
...
<Tabs syncKey='lang'>
  <TabItem label='Python' icon='seti:python'>
    <Code code={createLocalStatePython} lang='py' frame='none' />
  </TabItem>
</Tabs>

Refer [Sinppet Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L13-L21) to allocate local storage value for different data types
...
<Tabs syncKey='lang'>
  <TabItem label='Python' icon='seti:python'>
    <Code code={getLocalStoragePython} lang='py' frame='none' />
  </TabItem>
...
Refer [Sinppet Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L87-L99) to get local storage value for different data types
...
<Tabs syncKey='lang'>
  <TabItem label='Python' icon='seti:python'>
    <Code code={setLocalStoragePython} lang='py' frame='none' />
  </TabItem>
  <TabItem label='TEAL' icon='algorand-icon'>
...
Refer [Sinppet Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L102-L122) to set local storage value for different data types
...
<Tabs syncKey='lang'>
  <TabItem label='Python' icon='seti:python'>
    <Code code={deleteLocalStoragePython} lang='py' frame='none' />
  </TabItem>
  <TabItem label='TEAL' icon='algorand-icon'>
...
Refer [Sinppet Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L67-L84) to delete local storage value for different data types
