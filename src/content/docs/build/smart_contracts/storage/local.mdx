...
import createLocalStatePython from '/src/content/examples/storage-local-init-py.py?raw';
import getLocalStoragePython from '/src/content/examples/storage-local-init-py.py?raw';
import setLocalStoragePython from '/src/content/examples/storage-local-init-py.py?raw';
import deleteLocalStoragePython from '/src/content/examples/storage-local-init-py.py?raw'; 
import {
    getLocalStorageTEAL,
    setLocalStorageTEAL,
