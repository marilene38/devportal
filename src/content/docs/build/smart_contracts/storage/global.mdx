...
import createGlobalStatePython from '/examples/smart_contracts/py/storage-global-init-py.py?raw';
import getGlobalStoragePython from '/examples/smart_contracts/py/storage-global-get-py.py?raw';
import deleteGlobalStoragePython from '/examples/smart_contracts/py/storage-global-delete-py.py?raw';
import setGlobalStoragePython from '/examples/smart_contracts/py/storage-global-set-py.py?raw';
import {
