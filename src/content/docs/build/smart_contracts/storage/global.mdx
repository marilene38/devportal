...
import createGlobalStatePython from '/src/content/examples/storage-global-init-py.py?raw';
import getGlobalStoragePython from '/src/content/examples/storage-global-get-py.py?raw';
import deleteGlobalStoragePython from '/src/content/examples/storage-global-delete-py.py?raw';
import setGlobalStoragePython from '/src/content/examples/storage-global-set-py.py?raw';
import {
...
Refer [Sinppet Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L178-L226) to get global storage value for different data types
...
Refer [Sinppet Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L249-L252) to set global storage value for different data types
...
Refer [Sinppet Source](https://github.com/Asthay97/puya/blob/feature/kitchen-sink/examples/kitchen-sink/contract.py#L253-L258) to delete global storage value for different data types
