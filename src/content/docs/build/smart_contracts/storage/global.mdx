...
import createGlobalStatePython from '/src/examples/storage-global-init-py.py?raw';
import getGlobalStoragePython from '/src/examples/storage-global-get-py.py?raw';
import deleteGlobalStoragePython from '/src/examples/storage-global-delete-py.py?raw';
import setGlobalStoragePython from '/src/examples/storage-global-set-py.py?raw';
import {
