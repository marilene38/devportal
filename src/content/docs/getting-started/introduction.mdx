...
4. **First-class AI support:** Artificial intelligence tools such as Large Language Models (LLMs) have recently and swiftly revolutionized how many software developers work. This site embraces AI workflows in two key ways:
   - Embedded AI chat lets you ask questions about the content of the site and receive answers in real time, at any time
   - The entire site contents are also distilled down into an `llms.txt` file for consumption by your preferred AI tools
