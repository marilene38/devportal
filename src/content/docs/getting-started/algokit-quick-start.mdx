...
<LinkCard
  ...
  description='Learn about Algorand accounts, their structure, and how to create and manage them.'
/>
<LinkCard
  title='Assets'
  href='/concepts/assets/overview'
  description='Understand Algorand Standard Assets (ASAs) and how to create and manage them.'
/>
<LinkCard
  title='Transactions'
...
/>
<LinkCard
  title='Python on Algorand'
  href='/concepts/smart-contracts/languages/python'
  description='Learn more about building smart contracts in Python'
/>
<LinkCard
  title='TypeScript on Algorand'
  href='/concepts/smart-contracts/languages/typescript'
  description='Learn more about building smart contracts in TypeScript'
/>
