...
For more information, refer to [Consensus Overview](/protocol/overview).
...
3. Developer support: Access comprehensive documentation, project templates and examples, AI tools, and an active developer community on [Discord](https://discord.gg/algorand).
