...
{opcodes.map(({ Opcode, Name, Args, Returns, Doc, Groups, Size, IntroducedVersion, DocCost, DocExtra, ImmediateNote, ArgEnum, ArgEnumTypes }) => (
  ...
  <details key={Opcode} className="ml-6">
    <summary className="cursor-pointer p-2 border dark:border-gray-700 rounded flex justify-between items-center bg-gray-10 dark:bg-gray-800">
    ...
    <div className="inline-block p-2 bg-gray-100 dark:bg-gray-800 rounded-lg">
        ...
        <p className="mb-2 inline bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-1 rounded">{Groups}</p>
