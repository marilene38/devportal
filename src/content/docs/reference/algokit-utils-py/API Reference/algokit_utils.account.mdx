...
create_kmd_wallet_account(kmd_client: algosdk.kmd.KMDClient, name: str) → [algokit_utils.models.Account](algokit_utils.models.mdx#algokit_utils.models.Account)
...
get_account(client: algosdk.v2client.algod.AlgodClient, name: str, fund_with_algos: float = 1000, kmd_client: KMDClient | None = None) → [algokit_utils.models.Account](algokit_utils.models.mdx#algokit_utils.models.Account)
...
get_dispenser_account(client: algosdk.v2client.algod.AlgodClient) → [algokit_utils.models.Account](algokit_utils.models.mdx#algokit_utils.models.Account)
...
get_kmd_wallet_account(client: algosdk.v2client.algod.AlgodClient, kmd_client: algosdk.kmd.KMDClient, name: str, predicate: Callable[[dict[str, Any]], bool] | None = None) → [algokit_utils.models.Account](algokit_utils.models.mdx#algokit_utils.models.Account) | None
...
get_localnet_default_account(client: algosdk.v2client.algod.AlgodClient) → [algokit_utils.models.Account](algokit_utils.models.mdx#algokit_utils.models.Account)
...
get_or_create_kmd_wallet_account(client: algosdk.v2client.algod.AlgodClient, name: str, fund_with_algos: float = 1000, kmd_client: KMDClient | None = None) → [algokit_utils.models.Account](algokit_utils.models.mdx#algokit_utils.models.Account)
