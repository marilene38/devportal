...
opt_in(algod_client: algosdk.v2client.algod.AlgodClient, account: [algokit_utils.models.Account](algokit_utils.models.mdx#algokit_utils.models.Account), asset_ids: list[int]) → dict[int, str]
...
opt_out(algod_client: algosdk.v2client.algod.AlgodClient, account: [algokit_utils.models.Account](algokit_utils.models.mdx#algokit_utils.models.Account), asset_ids: list[int]) → dict[int, str]
