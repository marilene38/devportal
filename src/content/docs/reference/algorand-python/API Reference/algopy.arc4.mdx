...
### *classmethod* \_\_init_subclass_\_(\*, name: str = ..., scratch_slots: [algopy.urange](algopy.md#algopy.urange) | tuple[int | [algopy.urange](algopy.md#algopy.urange), ...] | list[int | [algopy.urange](algopy.md#algopy.urange)] = ..., state_totals: [algopy.StateTotals](algopy.md#algopy.StateTotals) = ..., avm_version: int = ...)
...
### clear_state_program() → [algopy.UInt64](algopy.md#algopy.UInt64) | bool

Represents the program called when `OnCompletion` == `ClearState`

<a id="algopy.arc4.Address"></a>

## *class* algopy.arc4.Address(value: [algopy.Account](algopy.md#algopy.Account) | str | [algopy.Bytes](algopy.md#algopy.Bytes) = ..., /)
...
### \_\_eq_\_(other: [algopy.arc4.Address](#algopy.arc4.Address) | [algopy.Account](algopy.md#algopy.Account) | str) → bool
...
### \_\_getitem_\_(index: [algopy.UInt64](algopy.md#algopy.UInt64) | int) → algopy.arc4._TArrayItem
...
### \_\_ne_\_(other: [algopy.arc4.Address](#algopy.arc4.Address) | [algopy.Account](algopy.md#algopy.Account) | str) → bool
...
### \_\_setitem_\_(index: [algopy.UInt64](algopy.md#algopy.UInt64) | int, value: algopy.arc4._TArrayItem) → algopy.arc4._TArrayItem

Sets the item of the array at specified index to provided value

<a id="algopy.arc4.Address.bytes"></a>

### *property* bytes *: [algopy.Bytes](algopy.md#algopy.Bytes)*
...
### *classmethod* from_bytes(value: [algopy.Bytes](algopy.md#algopy.Bytes) | bytes, /) → Self

Construct an instance from the underlying bytes (no validation)

<a id="algopy.arc4.Address.from_log"></a>

### *classmethod* from_log(log: [algopy.Bytes](algopy.md#algopy.Bytes), /) → Self

Load an ABI type from application logs, checking for the ABI return prefix `0x151f7c75`

<a id="algopy.arc4.Address.length"></a>

### *property* length *: [algopy.UInt64](algopy.md#algopy.UInt64)*

Returns the current length of the array

<a id="algopy.arc4.Address.native"></a>

### *property* native *: [algopy.Account](algopy.md#algopy.Account)*
...
## *class* algopy.arc4.BigUIntN(value: [algopy.BigUInt](algopy.md#algopy.BigUInt) | [algopy.UInt64](algopy.md#algopy.UInt64) | int = 0, /)
...
### \_\_eq_\_(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](algopy.md#algopy.UInt64) | [algopy.BigUInt](algopy.md#algopy.BigUInt) | int) → bool

Return self==value.

<a id="algopy.arc4.BigUIntN.__ge__"></a>

### \_\_ge_\_(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](algopy.md#algopy.UInt64) | [algopy.BigUInt](algopy.md#algopy.BigUInt) | int) → bool

Return self>=value.

<a id="algopy.arc4.BigUIntN.__gt__"></a>

### \_\_gt_\_(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](algopy.md#algopy.UInt64) | [algopy.BigUInt](algopy.md#algopy.BigUInt) | int) → bool

Return self>value.

<a id="algopy.arc4.BigUIntN.__le__"></a>

### \_\_le_\_(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](algopy.md#algopy.UInt64) | [algopy.BigUInt](algopy.md#algopy.BigUInt) | int) → bool

Return self<=value.

<a id="algopy.arc4.BigUIntN.__lt__"></a>

### \_\_lt_\_(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](algopy.md#algopy.UInt64) | [algopy.BigUInt](algopy.md#algopy.BigUInt) | int) → bool

Return self<value.

<a id="algopy.arc4.BigUIntN.__ne__"></a>

### \_\_ne_\_(other: [algopy.arc4.UIntN](#algopy.arc4.UIntN)[algopy.arc4._TBitSize] | [algopy.arc4.BigUIntN](#algopy.arc4.BigUIntN)[algopy.arc4._TBitSize] | [algopy.UInt64](algopy.md#algopy.UInt64) | [algopy.BigUInt](algopy.md#algopy.BigUInt) | int) → bool
...
### *property* native *: [algopy.BigUInt](algopy.md#algopy.BigUInt)*
...
## *class* algopy.arc4.Byte(value: [algopy.BigUInt](algopy.md#algopy.BigUInt) | [algopy.UInt64](algopy.md#algopy.UInt64) | int = 0, /)
...
### *property* native *: [algopy.UInt64](algopy.md#algopy.UInt64)*
...
### *property* native *: [algopy.Bytes](algopy.md#algopy.Bytes)*
...
## *class* algopy.arc4.String(value: [algopy.String](algopy.md#algopy.String) | str = '', /)
...
### \_\_eq_\_(other: [algopy.arc4.String](#algopy.arc4.String) | [algopy.String](algopy.md#algopy.String) | str) → bool
...
### *property* native *: [algopy.String](algopy.md#algopy.String)*
...
## *class* algopy.arc4.UIntN(value: [algopy.BigUInt](algopy.md#algopy.BigUInt) | [algopy.UInt64](algopy.md#algopy.UInt64) | int = 0, /)
...
## algopy.arc4.arc4_create(method: collections.abc.Callable[algopy.arc4._P, algopy.arc4._TABIResult_co], /, \*args: object, compiled: [algopy.CompiledContract](algopy.md#algopy.CompiledContract) = ..., on_completion: [algopy.OnCompleteAction](algopy.md#algopy.OnCompleteAction) = ..., fee: [algopy.UInt64](algopy.md#algopy.UInt64) | int = 0, sender: [algopy.Account](algopy.md#algopy.Account) | str = ..., note: [algopy.Bytes](algopy.md#algopy.Bytes) | bytes | str = ..., rekey_to: [algopy.Account](algopy.md#algopy.Account) | str = ...) → tuple[algopy.arc4._TABIResult_co, [algopy.itxn.ApplicationCallInnerTransaction](algopy.itxn.md#algopy.itxn.ApplicationCallInnerTransaction)]
...
## algopy.arc4.arc4_signature(signature: str, /) → [algopy.Bytes](algopy.md#algopy.Bytes)

Returns the ARC4 encoded method selector for the specified signature

<a id="algopy.arc4.arc4_update"></a>

## algopy.arc4.arc4_update(method: collections.abc.Callable[algopy.arc4._P, algopy.arc4._TABIResult_co], /, \*args: object, app_id: [algopy.Application](algopy.md#algopy.Application) | [algopy.UInt64](algopy.md#algopy.UInt64) | int, compiled: [algopy.CompiledContract](algopy.md#algopy.CompiledContract) = ..., fee: [algopy.UInt64](algopy.md#algopy.UInt64) | int = 0, sender: [algopy.Account](algopy.md#algopy.Account) | str = ..., note: [algopy.Bytes](algopy.md#algopy.Bytes) | bytes | str = ..., rekey_to: [algopy.Account](algopy.md#algopy.Account) | str = ...) → tuple[algopy.arc4._TABIResult_co, [algopy.itxn.ApplicationCallInnerTransaction](algopy.itxn.md#algopy.itxn.ApplicationCallInnerTransaction)]
