...
description: Guide to properly switch between different networks in Algorand
---

By default, an Algorand installation is configured to run on MainNet. For most users, this is the desired outcome. Developers, however, need access to TestNet or BetaNet networks. This guide describes switching between networks.
