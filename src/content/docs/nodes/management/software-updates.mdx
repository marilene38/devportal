...
If your node was installed using the [updater script](/nodes/installation/manual-installation#2-updater-script-installation), follow this approach. You can check for and install the latest updates by running the following at any time from within your node directory:
