...
![Screenshot of a typical NodeKit installation process](/src/assets/images/nodekit-install.png)
...
Check that your node meets the [hardware requirements](/nodes/installation/manual#hardware-requirements) for a participation node.
