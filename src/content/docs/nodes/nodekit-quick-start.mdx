...
import nodekitKeyregOnline from '@images/nodekit-keyreg-online.png';
import nodekitLoraKeyreg from '@images/nodekit-lora-keyreg.png';
import nodekitLoraTxnOk from '@images/nodekit-lora-txn-ok.png';
...
<Image src={nodekitKeyregOnline} alt='NodeKit key registration link screen' />
...
<Image src={nodekitLoraKeyreg} alt='Lora Transaction Wizard interface' />
...
<Image src={nodekitLoraTxnOk} alt='Lora transaction success confirmation' />
