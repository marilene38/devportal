...
See [Node Artifacts](https://developer.algorand.org/docs/run-a-node/reference/artifacts) for a complete list of installed files.
...
sudo apt-get install -y algorand-dev tools
...
After installation, Algorand is configured as a system service and starts automatically on MainNet. See [switching networks](https://developer.algorand.org/docs/run-a-node/operations/switch_networks/) for details on changing to another network.
