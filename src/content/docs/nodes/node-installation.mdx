...
See [Node Artifacts](reference/artifacts) for a complete list of installed files.
...
After installation, Algorand is configured as a system service and starts automatically on MainNet. See [switching networks](management/switch-network) for details on changing to another network.
