...
- [Searching the Blockchain](../../../get-details/indexer) feature guide
- [REST API Indexer reference](../../../rest-apis/indexer)
...
_**Info**: Additional installation methods will be available in the near future._
...
View all available options by running the [Indexer binary](../../clis/indexer/indexer.md) with the -h flag.
...
_**Note**: Create and start the database before launching the Indexer._
...
_**Info**: Initial database loading will take considerable time._
...
[View Indexer REST Endpoint specifications here.](../../../rest-apis/restendpoints/)
