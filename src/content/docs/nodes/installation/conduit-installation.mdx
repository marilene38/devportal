...
A Conduit pipeline is composed of 3 components, [Importers](http://localhost:4321/nodes/installation/conduit/plugins/importers/), [Processors](http://localhost:4321/nodes/installation/conduit/plugins/processors/), and [Exporters](http://localhost:4321/nodes/installation/conduit/plugins/exporters/).
Every pipeline must define exactly 1 Importer, exactly 1 Exporter, and can optionally define a series of 0 or more Processors. See a full list of available plugins with `conduit list` or the [plugin documentation page](http://localhost:4321/nodes/installation/conduit/plugins).
