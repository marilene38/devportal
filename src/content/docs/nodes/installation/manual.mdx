...
<Aside type='note'>
  The Key Manager Daemon (KMD) is Algorand's wallet process that manages keys
  and signing operations. It is used for wallet operations through the SDKs and
  REST API.
</Aside>
...
<Aside type='note'>
  After enabling or disabling telemetry, restart your node for changes to take
  effect.
</Aside>
