...
1. Verify your node meets the [hardware requirements](/nodes/installation/manual-installation#hardware-requirements). MainNet requires at least 16GB of RAM and cannot run on HDD/slow-SATA-SSD/SD.
...
:::tip 
Always enclose code/long outputs in triple backquotes or use the `code` button for better readability.
:::
