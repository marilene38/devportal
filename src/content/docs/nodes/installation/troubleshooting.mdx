...
:::tip To stay informed about new releases, subscribe to notifications on the
...
non-production environment before updating. ::: Consider using
...
1. Verify your node meets the
   [hardware requirements](/nodes/installation/manual-installation#hardware-requirements). MainNet
