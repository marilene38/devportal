// src/codeImports.js
import createGlobalStateTEAL from '/examples/smart-contracts/teal/storage-global-init.approval.teal?raw';
import getGlobalStorageTEAL from '/examples/smart-contracts/teal/storage-global-get.approval.teal?raw';
import setGlobalStorageTEAL from '/examples/smart-contracts/teal/storage-global-set.approval.teal?raw';
import deleteGlobalStorageTEAL from '/examples/smart-contracts/teal/storage-global-delete.approval.teal?raw';
import getLocalStorageTEAL from '/examples/smart-contracts/teal/storage-local-get.approval.teal?raw';
