    ...
    sidebar: [{
      ...
      // Each item here is one entry in the navigation menu.
      {
        ...
        items: [{
          ...
          autogenerate: {
            directory: "build/accounts/overview"
          }
        }, {
          label: "create",
          badge: {
          ...
          autogenerate: {
            directory: "build/accounts/create"
          }
        }, {
          label: "fund",
          badge: {
          ...
          autogenerate: {
            directory: "build/accounts/signing"
          }
        }]
      }, {
        label: "Assets",
        ...
        items: [{
          ...
          autogenerate: {
            directory: "build/smart_contracts/overview"
          }
        }, {
          label: "Applications",
          badge: {
          ...
          autogenerate: {
            directory: "build/smart_contracts/apps"
          }
        }, {
          label: "ABI",
          badge: {
        ...
        items: [{
          ...
          autogenerate: {
            directory: "build/transactions/overview"
          }
        }, {
          label: "Txn Types",
          badge: {
